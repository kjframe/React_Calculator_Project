                    ...
                    <div className="col-md-4">
                        <div class="card mb-3 pt-3 shadow">
                            <div class="card-body text-primary">
                                ...
                                <div className="col">
                                    <button className="btn btn-light text-primary shadow px-5 py-4 fs-4" value="C" onClick={()=> backspace()}>C/CE</button> 
                                </div>
                                <div className="row mt-2">
                                    ...
                                    <div className="col-3">   
                                        <button className="btn btn-light text-primary shadow px-4 py-4 fs-4" value="-" onClick={(e)=> setVal(val + e.target.value)}>-</button>
                                    </div>
                                </div>
                                <div className="row mt-2">
                                    <div className="col-3">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-3">   
                                        <button className="btn btn-light text-primary shadow px-4 py-4 fs-4" value="*" onClick={(e)=> setVal(val + e.target.value)}>X</button>
                                    </div>
                                </div>
                                <div className="row mt-2">
                                    <div className="col-3">
